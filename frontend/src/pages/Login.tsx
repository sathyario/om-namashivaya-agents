...
export default function Login() {
  ...
  const inputCls = 'w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-400 bg-white'

  const BrandPanel = () => (
    <div className="hidden lg:flex w-5/12 bg-[#0a2e2e] flex-col items-center justify-center px-12 text-white flex-shrink-0">
      <div className="text-7xl mb-6">🙏</div>
      <h1 className="text-3xl font-extrabold text-center leading-tight">Om Namashivaya Agents</h1>
      <p className="text-green-400 mt-3 text-base font-medium tracking-wide">Premium FMCG Distributor</p>
      <div className="mt-10 space-y-4 w-full max-w-xs">
        {[
          ['✅', 'Genuine Panasonic & Eveready products'],
          ['🚚', 'Free delivery on all orders'],
          ['💰', 'Cash on Delivery — pay when it arrives'],
          ['🏪', 'Exclusive wholesale pricing for shop owners'],
        ].map(([icon, text]) => (
      ...
      <div className="mt-12 text-xs text-white/30 text-center">
        Trusted by shop owners across Tamil Nadu
      </div>
    </div>
  )
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right — form panel */}
      <div className="flex-1 flex items-center justify-center bg-gray-50 px-4 py-10 overflow-y-auto">
